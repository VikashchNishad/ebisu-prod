...
(function () {
    ...
    module.exports = {
		...
		products:{
            saveMessageProducts: "Products saved successfully",
            updateMessageProducts: "Products updated successfully",
            deleteMessageProducts: "Products deleted successfully",
            saveMessageProductsCategory: "Products category saved successfully",
            updateMessageProductsCategory: "Products category updated successfully",
            deleteMessageProductsCategory: "Products category deleted successfully",
            saveMessageProductsImage: "Products image saved successfully",
            updateMessageProductsImage: "Products image updated successfully",
            deleteMessageProductsImage: "Products image deleted successfully",
            notFoundProducts: "Products not found",
            notFoundProductsCategory: "Products category not found",
            notFoundProductsImage: "Products image not found",
            fieldRequiredProducts: "Products title is required",
            fieldRequiredProductsCategory: "Category title is required",
            fieldRequiredProductsImage: "Please upload Products",
            alreadyExistsProducts: "Products with same title already exists",
            alreadyExistsCategory: "Category with same title already exists",
            coverImageWarning: "Cover image cannot be deleted",
            updateCoverImage: "Cover image updated successfully",

            saveMessageProductsSubCategory: "Products subcategory saved successfully",
            updateMessageProductsSubCategory: "Products subcategory updated successfully",
            deleteMessageProductsSubCategory: "Products subcategory deleted successfully",
            notFoundProductsSubCategory: "Products subcategory not found",
            fieldRequiredProductsSubCategory: "SubCategory title is required",
            alreadyExistsSubCategory: "SubCategory with same title already exists",


            validationErrMessage:{
                productsTitle : "Products title is required",
                categoryID : "Category of Products is required",
                productsDescription : "Products description is required",
                productsDate : "Products date is required",
                productsDateValid : "Products date should be a valid date"
            }
        },
        organizationInfo:{
		...
		store:{
            saveMessage: "Store saved successfully",
            updateMessage: "Store updated successfully",
            deleteMessage: "Store deleted successfully",
            notFound: "Store not found",
            validationErrMessage:{
                storeName : "Store name is required",
                addressLine1 : "addressLine1 is required",
                addressLine2 : "addressLine2 is required",
                storeArea : "StoreArea is required",
                pincode : "pincode is required",
                latitude : "latitude is required",
                longitude : "longitude is required",
                emailValid : "Invalid Email",
                facebookURLValid : "Facebook url should be a valid url",
                websiteURLValid : "website url should be a valid url",
                storeDateValid : "Invalid date"
            }
        },
