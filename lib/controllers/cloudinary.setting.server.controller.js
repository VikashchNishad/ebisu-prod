...
var CloudinarySettingController = (function () {
    ...
    var documentFields1 = '_id cloudinaryCloudName';
   ...
   _p.getCloudinaryNameSetting = function(){
        //get cloudinary setting with empty object as query parameter and documentFields as select fields
        return dataProviderHelper.findOne(CloudinarySetting, {}, documentFields1);
    };
    ...
    return{
        ...
        getCloudinaryNameSetting : _p.getCloudinaryNameSetting,
