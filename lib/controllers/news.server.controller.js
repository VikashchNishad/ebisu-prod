...
var newsController = (function () {
    ...
    var documentFieldsNews = '_id newsTitle urlSlog categoryID newsSummary newsDescription newsAuthor newsUrl newsDate pageViews active image addedOn';
    ...
    NewsModule.CreateNews = function (newsObj, modelHtmlObj, loggedInUser, imageInfo, _slogVal) {
        ...
        newsInfo.newsUrl = newsObj.newsUrl;
    ...
    _p.updateNewsFunc = function (req, res, modelInfo, _slogVal, next) {
        ...
        req.newsInfo.newsUrl = modelInfo.newsUrl;
    ...
    _p.getAllNewsImagesByNewsID = function (req) {
        ...
        var excludeFields = '-_id -newsTitle -urlSlog -categoryID -newsSummary -newsDescription -newsAuthor -newsUrl -pageViews -active -addedOn -newsDate -addedBy -updatedBy  -updatedOn -deleted -__v ';
