(function (pageViewController) {
    ...
    var Promise = require('bluebird'),
        ...
        storeController = require('../store.server.controller');
    ...
    pageViewController.init = function (app) {
      ...
      pageViewController.getStoresPageData = function (req, next) {
            req.query = {
                active: true,
                perpage: 100
            };
            ...
            return join(
                ...
                function (commonData, storeData) {
                    return {
                        commonData: commonData,
                        storeData: storeData.dataList
                    };
                });
