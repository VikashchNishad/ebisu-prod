    ...
    htmlRenderer.init = function (app, userLoginRouter) {
        ...
        app.get('/testimonial', function (req, res, next) {
          ...
          app.get('/store', function (req, res, next) {
            pageViewController.getStoresPageData(req, res, next)
                .then(function (resData) {
                    console.log(resData);
        ...
        app.get('/kadenceperience', function (req, res, next) {
            pageViewController.getTestimonialsPageData(req, res, next)
                .then(function (resData) {
                    res.render('pages/kadenceperience', {
                        data: resData,
                        activePageMenu: req.originalUrl
                    });
                })
         ...
         app.get('/kadencyngage', function (req, res, next) {
            pageViewController.getTestimonialsPageData(req, res, next)
                .then(function (resData) {
                    res.render('pages/kadencyngage', {
                        data: resData,
                        activePageMenu: req.originalUrl
                    });
                })
            ...
            pageViewController.getTestimonialsPageData(req, res, next)
                ...
                .catch(function (err) {
                    next(err);
                     ...
                     app.get('/privarypolicy', function (req, res, next) {
            pageViewController.getTestimonialsPageData(req, res, next)
                .then(function (resData) {
                    res.render('pages/privarypolicy', {
                        data: resData,
                        activePageMenu: req.originalUrl
                    });
                })
