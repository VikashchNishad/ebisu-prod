...
var cloudinarySettingRoutes = (function () {
    ...
    CloudinarySettingRouter.route('/cloudinaryName/')
        .get( getCloudinaryNameSetting );
    ...
    function getCloudinaryNameSetting(req, res, next) {
        CloudinarySettingController.getCloudinaryNameSetting()
            .then(function(cloudinarySetting){
                //if exists, return data in json format
                if (cloudinarySetting) {
                    res.status(HTTPStatus.OK);
